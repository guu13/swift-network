...
import (
	...
	"github.com/guu13/swift-network/internal/controller"
...
func init() {
	...
	utilruntime.Must(guuv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "swift-network.github.com",
	...
	//if err = (&controller.GuuTestReconciler{
